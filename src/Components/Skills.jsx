...
import { SiTailwindcss , SiTypescript , SiJavascript,SiHtml5,SiCss3,SiFirebase,SiMysql,SiWebflow,} from "react-icons/si";
export const Skills = () => {
  ...
  return (
    <div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-6">
        ...
        <SkillCard icon={<SiWebflow className="text-5xl color-seablue" />} title="Webflow" description="Webflow is a web design tool as well as a hosting platform and CMS all in one." />
